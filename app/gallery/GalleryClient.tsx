...
const media: MediaItem[] = [
  ...
  { type:'image', src:`${NEW}/custom-handrail-installation-new-home-warren-mi.jpg`, alt:'Custom stainless steel handrail installed in a new construction home in Warren, MI', label:'Handrail Installation', title:'Custom Handrail Installation — New Home Warren, MI', category:'Railings' },
  ...
  return (
    <>
      <style>{`
        ...
        .gl-lb-prev{left:32px;}.gl-lb-next{right:32px;}
      ...
      <div className="gl-wrap">
        <section className="gl-hero">
          <div className="gl-hero-line" /><div className="gl-hero-grid" /><div className="gl-hero-glow" />
