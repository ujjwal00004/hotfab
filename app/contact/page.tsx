  ...
  const info = [
    {
      ...
      sub: 'Metro Detroit Area',
      href: null,
    },
    {
      label: 'Phone',
      value: '(248) 259-9956',
      sub: 'Calls & texts welcome',
      href: 'tel:2482599956',
    },
    {
      label: 'Email',
      value: 'hotfabah@gmail.com',
      sub: 'Reply within 1 business day',
      href: 'mailto:hotfabah@gmail.com',
    },
    {
      label: 'Hours',
    ...
    <>
      <style>{`
        ...
        .cp-hero-sub {
          ...
          line-height: 1.8; margin-top: 28px; max-width: 480px;
        }
        .cp-hero-response {
          flex-shrink: 0;
        ...
        .cp-hero-response-num {
          font-family: 'Bebas Neue', sans-serif;
          font-size: 48px; line-height: 1; color: var(--forge);
        }
        .cp-hero-response-label {
        ...
        .cp-body-inner {
          max-width: 1100px; margin: 0 auto;
          display: grid; grid-template-columns: 1.15fr 1fr; gap: 2px;
          background: var(--slag);
          border: 1px solid var(--slag);
        }
        ...
        .cp-panel-sub {
          font-size: 13px; color: var(--smoke); letter-spacing: 1px;
        ...
        .cp-input, .cp-select, .cp-textarea {
          ...
          border: 1px solid var(--slag); border-bottom: 1px solid #3a3a3a;
        ...
        .cp-input:focus, .cp-select:focus, .cp-textarea:focus {
          ...
          background: rgba(200,65,10,0.03);
        }
        ...
        /* Submit */
        .cp-submit {
          width: 100%; background: var(--forge); color: var(--white);
          border: 2px solid var(--forge); padding: 20px;
          font-family: 'Barlow', sans-serif;
        ...
        .cp-submit-note {
          text-align: center; font-size: 11px; color: var(--smoke);
        ...
        .cp-success {
          ...
          min-height: 320px; text-align: center; gap: 20px;
        }
        .cp-success-icon {
        ...
        .cp-info-label {
          ...
          color: var(--forge); margin-bottom: 10px;
        }
        .cp-info-value {
        ...
        .cp-info-sub {
          font-size: 12px; color: var(--smoke); margin-top: 4px; font-weight: 300;
        }

        /* Emergency block */
        .cp-emergency {
          background: var(--forge); padding: 44px;
        }
        .cp-emergency-label {
          font-size: 10px; font-weight: 600; letter-spacing: 3px; text-transform: uppercase;
        ...
        .cp-emergency-title {
          font-family: 'Bebas Neue', sans-serif;
          font-size: 28px; color: var(--white); line-height: 1.1; margin-bottom: 20px;
        }
        .cp-emergency-phone {
          display: block;
          font-family: 'Bebas Neue', sans-serif;
        ...
        /* ── TRUST STRIP ── */
        .cp-trust {
          background: var(--steel); padding: 60px 48px;
          border-top: 1px solid var(--slag);
        }
        .cp-trust-inner {
          max-width: 1100px; margin: 0 auto;
        ...
        .cp-trust-num {
          font-family: 'Bebas Neue', sans-serif;
          font-size: 44px; color: var(--white); line-height: 1; margin-bottom: 6px;
        }
        ...
        @media (max-width: 900px) {
          .cp-hero { padding: 140px 24px 64px; }
          .cp-hero-inner { grid-template-columns: 1fr; }
          .cp-hero-response { display: none; }
          .cp-body { padding: 0 24px 80px; }
          .cp-body-inner { grid-template-columns: 1fr; }
          .cp-form-panel { padding: 48px 28px; }
          .cp-field-row { grid-template-columns: 1fr; gap: 0; }
          .cp-trust { padding: 48px 24px; }
          .cp-trust-inner { grid-template-columns: 1fr 1fr; }
          .cp-info-item { padding: 28px 28px; }
          .cp-emergency { padding: 36px 28px; }
          .cp-services-link { padding: 20px 28px; }
        }
          ...
          <div className="cp-hero-inner">
            <div>
              ...
              <p className="cp-hero-sub">
                Ready to start your project? Fill out the form or call us directly. We respond within one business day — usually faster.
              </p>
            </div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="cp-field">
                    ...
                    <textarea
                      ...
                      placeholder="Describe your project — dimensions, material, location, timeline..."
        ...
        <section className="cp-trust">
          <div className="cp-trust-inner">
            {[
              ...
              { num: '2K+', label: 'Projects Completed' },
              { num: '5★', label: 'Google Rating' },
              { num: '1', label: 'Day Response Time' },
            ].map((t, i) => (
